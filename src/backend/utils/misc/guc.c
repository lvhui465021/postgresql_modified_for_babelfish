 ...
 */
PGDLLIMPORT guc_push_old_value_hook_type guc_push_old_value_hook = NULL;
PGDLLIMPORT validate_set_config_function_hook_type validate_set_config_function_hook = NULL;
